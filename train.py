...
def train():
    #load_model_path = '/home/sayanchaki/Downloads/GMAIR-pytorch-main2/logs/von_mises_larger/2024_11_06__01_46_22/checkpoints/step_187000.pkl'
    load_model_path = None
    start_iter = 0
    image_shape = cfg.input_image_shape
    
    if cfg.dataset == 'multi_mnist':
        data = SimpleScatteredMNISTDataset('/home/sayanchaki/Downloads/GMAIR-pytorch-main2/logs/von_mises_larger/2024_11_06__01_19_34/checkpoints/step_207000.pkl')
    ...
    gmair_net = gmair(image_shape).to(device)
    ...
    '''input_shape=(6,3,128,128)
    flops, macs, params = calculate_flops(model=gmair_net, 
